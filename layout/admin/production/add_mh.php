      ...
      <div class="main_container">
         ...
         <div class="content">
            <div class="panel-heading">
               <h2 class="text-center"style="color:white;font-size:24px;font-weight:bold;">THÊM MẶT HÀNG MỚI </h2>
            </div>
           
            <form action = "proccess_add.php" method= 'post'style="width:80%;padding:0px 10%;">
               <label for="name"style="font-size:20px;" >Tên Sản Phẩm</label>
               <input type="text" class="form-control" name="name"><br>
               <label for="type"style="font-size:20px;">Loại sản phẩm</label><br>
               <input type="text" class="form-control"  name="type"><br>
               <label for="price"style="font-size:20px;" >Giá Sản Phẩm</label><br>
               ...
               <button class = "btn btn-success btnaddmh" id = 'btnaddmh' type="submit">Thêm mặt hàng</button>
