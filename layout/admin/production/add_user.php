      ...
      <div class="main_container">
         ...
         <div class="content">
            <div class="panel-heading">
               <h2 class="text-center"style="color:white;font-size:24px;font-weight:bold;">THÊM THÔNG TIN KHÁCH HÀNG </h2>
            </div>
           
            <form action = "proccess_adduser.php" method= 'post'style="width:80%;padding:0px 10%;">
               ...
               <input type="text" class="form-control" name = 'account'><br><br>
               <label for="password"style="font-size:16px;" >Mật Khẩu</label><br>
               <input type="text" class="form-control" name = 'password'><br><br>
               <button class = "btn btn-success btnaddmh" id = 'btnaddmh' type="submit">Thêm Khách Hàng</button>
