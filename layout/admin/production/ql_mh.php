...
<body class="nav-md">
  ...
  <!-- /top navigation -->
    <div class="content" style="padding:0px 10%;">
        <table class="table table-bordered table-hover">
          <thead class="thr-main">
              <tr style="text-align:center;">
                ...
                <th width = "10%">Giá</th>
                <th width = "10%">Loại</th> 
                <th width = "10%">ảnh 1</th>
                <th width = "10%">ảnh 2</th>
                <th width = "10%">ảnh 3</th>
                <th width="12%"></th>
                <th width="8%"></th>
              </tr>
          </thead>
              ...
              if(mysqli_num_rows($result)>0){
                ...
                while($row = mysqli_fetch_assoc($result)){
                  echo "
                    ...
                    <td>".$row['item_id']."</td>
                    <td>".$row['item_name']."</td>
                    <td>".$row['item_price']." vnđ</td>
                    <td>".$row['item_type']."</td>
                    <td>".$row['item_linkimg1']."</td>
                    <td>".$row['item_linkimg2']."</td>
                    <td>".$row['item_linkimg3']."</td>
                    <td><button  style='margin: 0px 10%;text-align:center;heigh:30px;'class='btn btn-warning' ><a href='update_mh.php?id=".$row['item_id']."'>Cập nhật</a></button></td>
                    <td><button  class='btn btn-danger' ><a href='delete_mh.php?id=".$row['item_id']."'onclick='return confirm(".$question.")'>Xóa</a></button></td>
                    </str>
                  ";
                }
              }     
        ...
        <button class="btn btn-success" ><a href="add_mh.php" style="color: black;">Thêm mặt hàng mới</a> </button>
    </div>
